...
# --- ОБФУСКАЦИЯ СЕКРЕТА ---
# Вместо: LICENSE_SECRET = "ChangeMeToAPrivateSecret"
# Теперь секрет собирается из двух частей и декодируется из Base64
...
# --- ФУНКЦИЯ ГЕНЕРАЦИИ КЛЮЧА УДАЛЕНА ---
...
def _build_cli_parser() -> argparse.ArgumentParser:
    ...
    # --- АРГУМЕНТ --generate-license УДАЛЁН ---
    parser.add_argument(
        "--splash-logo",
        metavar="PATH",
        type=Path,
...
if __name__ == "__main__":
    ...
    # --- ЛОГИКА ГЕНЕРАЦИИ КЛЮЧА УДАЛЕНА ---
